        ...
        const html = `
            <div class="alert-card alert-${(alert.color || "green").toLowerCase()}">
                ...
                <div class="alert-body">
                    <p><strong>Fault:</strong> ${maintenanceData.fault || "Normal"}</p>
                    <p><strong>Probability:</strong> ${maintenanceData.probability ?? 0}%</p>
                    <p><strong>Confidence:</strong> ${maintenanceData.confidence ?? 100}%</p>
                    <p><strong>RUL:</strong> ${Number(rul.hours || 0).toFixed(0)} h</p>
